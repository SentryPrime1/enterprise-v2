                    ...
                    try {
                        ...
                        if (result.success) {
                            resultsContent.innerHTML = \`
                                ...
                                <ul>
                                    <li>Critical: \${result.violations.filter(v => v.impact === 'critical').length}</li>
                                    <li>Serious: \${result.violations.filter(v => v.impact === 'serious').length}</li>
                                    <li>Moderate: \${result.violations.filter(v => v.impact === 'moderate').length}</li>
                                    <li>Minor: \${result.violations.filter(v => v.impact === 'minor').length}</li>
                                </ul>
